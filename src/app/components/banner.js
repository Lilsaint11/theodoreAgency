    ...
    return ( 
        <div className="mt-28 max-md:mt-16">
            <div className="flex flex-col gap-5">
                ...
                <h3 className="text-xl max-[470px]:text-[14px] max-sm:text-lg leading-loose">Profitable dropshipping stores based on existing top selling shopify stores,<br/> so you're ready to start getting sales!</h3>
                <div>
